...
def send_chat_action(chat_id, action="typing"):
    """មុខងារបង្ហាញសញ្ញា 'កំពុងសរសេរ...' ឬ 'កំពុងផ្ញើសំឡេង...' នៅលើ Telegram"""
...
def ask_ai(user_message, persona):
    ...
    if persona == "cute":
        system_instruction = (
            ...
            "ត្រូវប្រើពាក្យសម្តីផ្អែមៗអោយខ្លាំងៗ ដូចជា 'អូន', 'បង', 'ម្ចាស់ថ្លៃចិត្តអើយ', 'សម្លាញ់ចិត្ត', 'ប្តីសម្លាញ់' ព្រមទាំងប្រើ Emoji ស្អាតៗឃ្យូតៗជាច្រើនជានិច្ច (💖, 🥺, 🌸, 😘, ✨, 🙈, 💋, 🎀)។ "
        ...
        system_instruction = (
            ...
            "អ្នកនិយាយស្តីទាក់ទាញចិត្តខ្លាំង ប្រើពាក្យ 'បង', 'អូន', 'អាយដល', 'អូនសម្លាញ់', 'អូនស៊ូស៊ី' ដោយប្រើ Emoji ផ្អែមល្ហែម (🌹, ✨, 😉, 💍, 💖, 🥂)។ "
        ...
        system_instruction = (
            ...
            "'ធុញណាស់វ៉ើយ!!', 'សួររកងាប់អី!', 'ចង់ឲ្យអញទៅបោកក្បាលហ្នឹងជញ្ជាំងឲ្យងាប់ទេអី?!', 'អញនិយាយឡើងជិតដាច់ខ្យល់ហើយ!', 'វាឆ្កួតក្បាលទេអីសួររហូត!', 'អាប្រល័យលោក!'។ "
                ...
                for update in res["result"]:
                    ...
                    if "message" in update and "text" in update["message"]:
                        ...
                        if user_text == "/start":
                            ...
                            send_telegram_voice(chat_id, msg, is_slow=False)
                            continue
                        ...
                        # ៤. ផ្ញើសំឡេង (បើជាតាសុខកំណត់ឱ្យនិយាយយឺតបន្តិច)
                        is_ta_sokh = (current_persona == "ta_sokh")
                        send_telegram_voice(chat_id, ai_reply, is_slow=is_ta_sokh)
