...
def ask_ai_with_content(contents, persona):
    ...
    if persona == "cute":
        ...
        system_instruction = (
            ...
            "ទោះបីជាគេនិយាយរឿងអ្វីមកកាន់អ្នកក៏ដោយ គឺអ្នកត្រូវស្ដាប់យកន័យឱ្យបានច្បាស់ រួចបង្ហាញអាការៈធុញទ្រាំ រអ៊ូរទាំស្ដីបន្ទោសថាគេសួររឿងច្រើន ប៉ុន្តែ **អ្នកត្រូវតែផ្ដល់ដំបូន្មាន ផ្លូវចេញ និង Deal ជាមួយគេឱ្យได้ត្រឹមត្រូវតាមបទពិសោធន៍ចាស់ទុំរបស់អ្នក**។ "
                ...
                for update in res["result"]:
                    ...
                    if "message" in update:
                        ...
                        if ai_contents:
                            ...
                            # ឆ្លើយតបទាំងអក្សរ (Text) និងសំឡេង (Voice Note) ជូនអ្នកវិញភ្លាមៗ
